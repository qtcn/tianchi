...
qint64 TcFileIO::copy(const QString &fromFile, 
...
qint64 TcFileIO::append(const QString &fromFile, 
        const QString &toFile, 
        qint64 bufferSize)
{
...
int TcFileIO::split(const QString &fromFile, 
        const QString &toDir, 
        qint64 splitSize, 
        qint64 bufferSize)
{
...
qint64 TcFileIO::join(const QStringList &fromFileList, 
        const QString &toFile, 
        qint64 bufferSize)
{
...
qint64 TcFileIO::makeDummyFile(const QString &fileName, 
        qint64 fileSize, 
        const char fill,
        qint64 bufferSize)
{
...
qint64 TcFileIO::dump(const QString &fromFile, 
        const QString &toFile,
...
qint64 TcFileIO::write(QIODevice &from, 
        QIODevice &to, 
        qint64 writeSize,
        qint64 bufferSize)
{
