...
QStringList ExcelReader::sheetNames()
{
    Q_D(ExcelReader);
    return d->sheetNames;
}

int ExcelReader::currentSheetIndex()
{
    Q_D(ExcelReader);
    return d->currentSheetIndex;
}

QString ExcelReader::currentSheetName()
{
    Q_D(ExcelReader);
...
bool ExcelReader::setCurrentSheet(int index)
{
    Q_D(ExcelReader);
...
bool ExcelReader::setCurrentSheet(const QString &sheetName)
{
    Q_D(ExcelReader);
